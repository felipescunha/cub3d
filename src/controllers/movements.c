...
/*   Updated: 2023/07/22 14:40:13 by marolive         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cub3d->map[(int)cub3d->pos_y][(int)(cub3d->pos_x
		+ cub3d->dir_x * cub3d->move_speed)] == '0')
		cub3d->pos_x += cub3d->dir_x * cub3d->move_speed;
	if (cub3d->map[(int)(cub3d->pos_y + cub3d->dir_y
			* cub3d->move_speed)][(int)(cub3d->pos_x)] == '0')
...
{
	if (cub3d->map[(int)cub3d->pos_y][(int)(cub3d->pos_x
		+ cub3d->plane_x * cub3d->move_speed)] == '0')
		cub3d->pos_x += cub3d->plane_x * cub3d->move_speed;
	if (cub3d->map[(int)(cub3d->pos_y + cub3d->plane_y
			* cub3d->move_speed)][(int)(cub3d->pos_x)] == '0')
